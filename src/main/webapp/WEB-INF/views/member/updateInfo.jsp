...
<div class="updateInfo-modal">
	...
	<div class="modal-content">
		<form class="update-info-detail" action="${pageContext.request.contextPath}/member/login" method="post">
			<div class="update_nickname">
				<div class="nickname-input">
					<label for="update-nick">닉네임 수정</label>
					<input type="text" id="update-nick" name="update-nick" placeholder="닉네임을 입력하세요">
				</div>
